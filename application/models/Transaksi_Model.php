...
class Transaksi_Model extends CI_Model
{
  ...
  {
    return $this->db->query("SELECT tb_persediaan_barang.id_transaksi, tb_persediaan_barang.id_barang, tb_persediaan_barang.qty, tb_persediaan_barang.tanggal_transaksi, tb_persediaan_barang.harga, tb_persediaan_barang.ket, tb_persediaan_barang.status_verifikasi, tb_persediaan_barang.ket_status, tb_persediaan_barang.id_user, tb_barang.barang, tb_barang.durasi_exp, tb_satuan.satuan, tb_jenis.jenis FROM tb_persediaan_barang INNER JOIN tb_barang ON tb_persediaan_barang.id_barang=tb_barang.id_barang INNER JOIN tb_satuan ON tb_satuan.id_satuan=tb_barang.id_satuan INNER JOIN tb_jenis ON tb_jenis.id=tb_barang.id_jenis WHERE tb_jenis.jenis <> 'Bahan Baku' AND tb_persediaan_barang.id_user= '$id_user' ORDER BY tb_persediaan_barang.tanggal_transaksi DESC")->result_array();
  }
  ...
  public function UpdatePersediaanBarang()
  {
    $data_barang = [
      ...
      "ket_status"          => $this->input->post('ket', true)
    ];
    $this->db->where("id_transaksi", $this->input->post('id_transaksi', true));
    $this->db->update('tb_persediaan_barang', $data_barang);
  }
  ...
  {
    return $this->db->query("SELECT tb_barang_keluar.id_transaksi, tb_barang_keluar.id_barang, tb_barang_keluar.harga, tb_barang_keluar.qty, tb_barang_keluar.tanggal_transaksi, tb_barang.barang, tb_satuan.satuan FROM tb_barang_keluar INNER JOIN tb_barang ON tb_barang_keluar.id_barang=tb_barang.id_barang INNER JOIN tb_satuan ON tb_satuan.id_satuan=tb_barang.id_satuan")->result_array();
  }
  ...
  {
    return $this->db->query("SELECT tb_barang_terjual.id_transaksi, tb_barang_terjual.id_barang, tb_barang_terjual.harga, tb_barang_terjual.qty, tb_barang_terjual.tanggal_transaksi, tb_barang.barang, tb_satuan.satuan FROM tb_barang_terjual INNER JOIN tb_barang ON tb_barang_terjual.id_barang=tb_barang.id_barang INNER JOIN tb_satuan ON tb_satuan.id_satuan=tb_barang.id_satuan")->result_array();
  }
