                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row" id="per-tanggal">
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="date" class="form-control" name="dr-tgl" id="dr-tgl-persediaan">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="date" class="form-control" name="sm-tgl" id="sm-tgl-persediaan">
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <div class="row" id="per-bulan">
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select class="form-control show-tick form-line"  name="per-bulan" id="bulan-persediaan">
                                ...
                                <div class="form-group form-float" id="per-tahun">
                                    <div class="form-line">
                                        <select class="form-control show-tick form-line"  name="per-tahun" id="tahun-persediaan">
                                            <option>--Pilih Tahun--</option>
                                            <?php
                                                for($i=date('Y');$i>=date('Y')-2;$i--){
                                                    echo"<option value='".$i."'>".$i."</option>";
