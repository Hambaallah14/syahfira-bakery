    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                            <a href="<?=base_url();?>persediaan_barang/tambah_persediaan" class="btn bg-brown">Tambah Persediaan</a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable" ><!--dataTable js-exportable" -->
                                ...
                                <tbody>
                                    <?php
                                        $no=1;
                                        foreach($daftar_persediaan as $brg){
                                            echo"<tr>";
                                                echo "<td class='text-center'>".$no."</td>";
                                                echo "<td>".$brg["id_persediaan"]."</td>";
                                                echo "<td class='text-center'>".date('d F Y', strtotime($brg["tanggal_persediaan"]))."</td>";
                                                echo "<td class='text-center'>";
                                                    echo"<div class='demo-google-material-icon'>";
                                                        echo"<a href='".base_url()."persediaan_barang/review_persediaan/".$brg["id_persediaan"]."' title='Review'>";
