<div class="flash-data" data-target="Persediaan Barang" data-dataflash="<?= $this->session->flashdata('flash'); ?>"></div>
<section class="content">
    <div class="container-fluid">
        <div class="row clearfix">    
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <?php echo form_open("persediaan_barang/add", array('enctype'=>'multipart/form-data', 'id' => 'form_validation')); ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="header">
                                <h2>Tambah Persediaan Barang</h2>
                            </div>
                            <div class="body">             
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control id_persediaan" name="id_persediaan" value="<?=$kode; ?>" readonly="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="body">
                                ...
                                <button class="btn bg-brown waves-effect tambah_list_persediaan" type="button">Tambah List</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
