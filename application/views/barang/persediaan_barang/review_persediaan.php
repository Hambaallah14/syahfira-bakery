...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="block-header">
            <h2>Rincian Persediaan Barang</h2>
        </div>
                ...
                <div class="card">
                    <div class="body">
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            <tbody>    
                                <tr>
                                    <td width="35%">ID Persediaan</td>
                                    <td width="5%">:</td>
                                    <td width="60%"><?=$rincian_persediaan[0]['id_persediaan'];?></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Persediaan</td>
                                    <td>:</td>
                                    <td><?=date('d F Y', strtotime($rincian_persediaan[0]['tanggal_persediaan']));?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    <?php
                                        $no=1;
                                        $total = 0; 
                                        foreach($rincian_persediaan as $brg){
                                            echo"<tr>";
