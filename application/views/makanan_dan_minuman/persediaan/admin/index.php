<div class="flash-data" data-target="Persediaan Makanan dan Minuman" data-flashdata="<?= $this->session->flashdata('makanan_minuman'); ?>"></div>
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    foreach ($daftar_user as $user) {
                                        ...
                                        echo "<td><a href='" . base_url() . "makanan_dan_minuman/persediaan_cabang/" . $user["id_user"] . "'><i class='material-icons'>visibility</i></a></td>";
                                        echo "</tr>";
                                        $no++;
                                    }
                                    ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open("makanan_dan_minuman/InsertPersediaan", array('enctype' => 'multipart/form-data', 'id' => 'form_validation')); ?>
                                ...
                                <div class="form-line">
                                    <select id="id_mkn_mnm" class="form-control show-tick id_mkn_mnm" name="id_mkn_mnm" required>
                                        ...
                                        foreach ($makanan_minuman as $brg) {
                                            echo "<option value='" . $brg["id"] . "'>" . $brg['makanan_minuman'] . "</option>";
                                        }
                                        ?>
                                    </select>
