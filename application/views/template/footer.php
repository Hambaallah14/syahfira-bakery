...
<script src="<?=base_url();?>assets/plugins/editable-table/mindmup-editabletable.js"></script>
 ...
 <!-- Custom Js -->
<!-- <script src="<?=base_url();?>assets/plugins/js/admin.js"></script>
<script src="<?=base_url();?>assets/plugins/js/pages/tables/editable-table.js"></script> -->
...
<!-- <script src='<?=base_url();?>assets/plugins/edit/script2.js' type='text/javascript'></script> -->


<!-- Print -->
<script src="<?=base_url();?>assets/plugins/printarea/js/jquery.printarea.js"></script>
