                                ...
                                <tbody>
                                    ...
                                    foreach ($bahan_baku as $persediaan) {
                                        ...
                                        if ($persediaan["status_verifikasi"] == 0) {
                                            echo "<td class='text-center'><a href='" . base_url() . "transaksi/pindai_stok/barang_sisa/" . $persediaan["id_transaksi"] . "' class='btn bg-primary btn-barang-sisa'>Verifikasi</a></td>";
                                        } else {
